        ...
        <div className="container mx-auto px-4 py-8">
            ...
            >
                <div className="md:w-1/2">
                    <img src="https://source.unsplash.com/1600x1000/?books,about" alt="About BookishHub" className="rounded-lg shadow-lg" />
                </div>
                <div className=" md:w-1/2 max-w-3xl mx-auto">
                    ...
                    <div className="text-lg text-gray-700 mb-6">
                        Ready to dive in? <Link href="/" className="text-blue-600 hover:underline">Start exploring</Link> now!
                    </div>
                </div>
            </motion.div>
        </div>
